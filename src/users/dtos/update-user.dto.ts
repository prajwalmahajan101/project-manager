...
export class UpdateUserDto {
  ...
  @ApiPropertyOptional({ type: String, example: 'prajwal-admin-1' })
  @IsOptional()
  username?: string;
  ...
  @ApiPropertyOptional({ type: String, example: 'abc@1234' })
  @IsOptional()
  password?: string;
  ...
  @ApiPropertyOptional({ type: String, example: 'SDE-2 (Backend)' })
  @IsOptional()
  designation?: string;
}
